...
<style>
  @page { margin: 0.6in; }
  html, body { font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif; color: #1E2D24; }
  body { font-size: 11pt; line-height: 1.45; margin: 0; }
  h1 { font-size: 18pt; margin: 0 0 0.2em; letter-spacing: -0.01em; }
  h2 { font-size: 13pt; margin: 1.2em 0 0.4em; color: #3A5347; }
  h3 { font-size: 11pt; margin: 1em 0 0.3em; color: #3A5347; }
  .meta { font-size: 9pt; color: #687F73; margin-bottom: 1em; }
  .chip { display: inline-block; font-size: 9pt; padding: 1px 6px; border: 1px solid #DEEBE3; border-radius: 4px; color: #3A5347; margin-right: 4px; }
  table { width: 100%; border-collapse: collapse; font-size: 10pt; margin: 0.5em 0 1em; }
  thead th { text-align: left; border-bottom: 1px solid #CADDD0; padding: 6px 8px; color: #687F73; font-weight: 600; }
  tbody td { padding: 6px 8px; border-bottom: 1px solid #DEEBE3; vertical-align: top; }
  .subtle { color: #687F73; font-size: 9pt; }
  .timeline { list-style: none; padding: 0; margin: 0; }
  .timeline li { padding: 6px 0 6px 12px; border-left: 2px solid #DEEBE3; margin-left: 2px; }
  .timeline .ts { font-size: 9pt; color: #687F73; }
  .footer { margin-top: 2em; padding-top: 0.8em; border-top: 1px solid #DEEBE3; font-size: 9pt; color: #687F73; }
