...
export const announcements: Announcement[] = [
  ...
  },
  {
    ...
    title: "FL hurricane preparedness sales-tax holiday extended",
    summary:
      "Florida DOR has extended the 2026 hurricane preparedness sales-tax holiday from 14 to 21 days, running June 1–21. Eligible items unchanged.",
    ...
    entityTypes: ["LLC", "S-Corp", "C-Corp"],
    taxTypes: ["Sales tax"],
    sourceUrl: "https://floridarevenue.com/2026/hurricane-prep-holiday",
    sourceAuthority: "primary",
    relatedAnnouncementIds: [],
    parseConfidence: "high",
    matchConfidence: "high",
