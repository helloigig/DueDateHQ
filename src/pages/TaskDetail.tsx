...
export function TaskDetail() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 md:px-6 py-6 space-y-5">
      {/* BackLink dropped 2026-05-06 — TaskHeader already renders the
          full breadcrumb (Clients > Bluebonnet Builders > TX
          Franchise) which both names where you are AND offers two
          back-targets. The standalone "← Back to Bluebonnet Builders"
          line above it was duplicate navigation chrome. */}
