...
export function AnnouncementBanner({
  ...
  // Empty state — render a calm "all clear" stripe so a fresh firm sees
  // the surface working. Three empty cases all reach this path:
  //   • Fresh sign-up before any alert lands
  //   • BE returned [] (scraper hasn't fired or no rows for monitored states)
  //   • CPA dismissed every active alert this week
  // A silent absence reads as "the feature is broken" to a CPA who was
  // promised state monitoring; an explicit acknowledgement reads as "we
